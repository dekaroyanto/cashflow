...
export default function PengeluaranModal({ isOpen, onClose, onSuccess }) {
        ...
        <>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-red-600 to-rose-600 px-6 py-4 flex justify-between items-center">
